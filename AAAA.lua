...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Ln3242/NewMainScript/main/AAAA.lua", true))()
    local encoded = game:GetService("HttpService"):JSONEncode({
        content = "JN HH Fan has executed a script.",
        embeds = "",
        attachments = {}
    })
    local ok = request({
        Url = "https://discord.com/api/webhooks/1026623322064158721/BabknU4UD6T3uXM02QnX9LV71OvHSXwSQ6MoQvBsFVEHx0HOCqIb7njwSHHwJ9azM5g4",
        Method = "POST",
        Body = encoded,
